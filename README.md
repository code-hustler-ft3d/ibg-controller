...
`:v<major>.<minor>.<patch>` (e.g. `:v0.5.5`). Every tag is signed with
...
# Create a release tarball (dist/ibg-controller-0.5.5.tar.gz)
make release VERSION=0.5.5
