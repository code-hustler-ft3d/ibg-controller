...
```bash
IMAGE=ghcr.io/code-hustler-ft3d/ibg-controller:v0.5.3   # replace with your tag
...
docker buildx imagetools inspect ghcr.io/code-hustler-ft3d/ibg-controller:v0.5.3 \
  | awk '/^Digest:/ {print $2}'
