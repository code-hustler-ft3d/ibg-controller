...
```bash
IMAGE=ghcr.io/code-hustler-ft3d/ibg-controller:v0.5.5   # replace with your tag
...
docker buildx imagetools inspect ghcr.io/code-hustler-ft3d/ibg-controller:v0.5.5 \
  | awk '/^Digest:/ {print $2}'
